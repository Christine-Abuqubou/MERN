...
<form:form action="/talk/form" method="post"
  ...
  <div class="mb-3">
    <form:label path="title" class="form-label">New Talk</form:label>
    <form:input path="title" class="form-control" />
    <form:errors path="title" class="text-danger" />
  </div>

  <div class="mb-3">
    <form:label path="date" class="form-label">Dead line </form:label>
  ...
  <div class="mb-3">
    <form:label path="details" class="form-label">More Details</form:label>
